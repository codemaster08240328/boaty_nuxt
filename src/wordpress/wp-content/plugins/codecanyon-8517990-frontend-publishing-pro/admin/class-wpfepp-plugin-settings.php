...
class WPFEPP_Plugin_Settings
{
	 ...
	 **/
	public function __construct($version, $textdomain, $parent_page)
	{
		...
		$media_tab 			= new WPFEPP_Tab_Settings_Media($version, $this->textdomain, 'media', __('Media', $this->textdomain));
		$list_tab 			= new WPFEPP_Tab_Settings_List($version, $this->textdomain, 'post_list', __('Post List', $this->textdomain));
		$data_tab 			= new WPFEPP_Tab_Settings_Data($version, $this->textdomain, 'data', __('Data', $this->textdomain));
		$errors_tab 		= new WPFEPP_Tab_Settings_Errors($version, $this->textdomain, 'errors', __('Errors', $this->textdomain));
		$email_tab 			= new WPFEPP_Tab_Settings_Email($version, $this->textdomain, 'email', __('Email', $this->textdomain));
		$copyscape_tab 		= new WPFEPP_Tab_Settings_CopyScape($version, $this->textdomain, 'copyscape', __('CopyScape', $this->textdomain));
		$recaptcha_tab 		= new WPFEPP_Tab_Settings_ReCaptcha($version, $this->textdomain, 'recaptcha', __('ReCaptcha', $this->textdomain));
	...
	public function add_menu_item(){
		$this->page_hook = add_submenu_page( $this->parent_page, __('Frontend Publishing Settings', $this->textdomain), __('Settings', $this->textdomain), 'manage_options', $this->page, array($this, 'render_settings_page') );
	}
	...
	public function render_settings_page(){
		...
		<h2><?php _e('Frontend Publishing Settings', $this->textdomain); ?></h2>
			<?php settings_errors(); ?>
	...
	public function update_settings(){
		...
		$default_errors = array(
				'form' 			=> __("There are errors in your submission. Please try again.", $this->textdomain),
				'required' 		=> __("This field is required.", $this->textdomain),
				'min_words' 	=> __("Please enter atleast {0} words.", $this->textdomain),
				'max_words' 	=> __("You can't enter more than {0} words.", $this->textdomain),
				'max_links' 	=> __("You can't enter more than {0} links.", $this->textdomain),
				'min_segments' 	=> __("Please enter atleast {0}.", $this->textdomain),
				'max_segments' 	=> __("You can't enter more than {0}.", $this->textdomain),
				'invalid_email'	=> __("Please enter a valid email address.", $this->textdomain),
				'invalid_url'	=> __("Please enter a valid URL.", $this->textdomain),
				'copyscape'		=> __("The content you have entered is not original.", $this->textdomain)
			);
