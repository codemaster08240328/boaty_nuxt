...
class WPFEPP_Admin_Messages
{
	...
	public function admin_notices() {
		...
		?>
		    <div class="updated">
		        <p>
		        	<?php _e('Thank you for installing the latest version of Frontend Publishing Pro! Please review your settings to make sure everything is in order', $this->textdomain); ?>.<br/>
		        	<a target="_blank" href="http://codecanyon.net/item/frontend-publishing-pro/8517990#item-description__change-log"><?php _e("What's New", $this->textdomain); ?></a> | 
		        	<a target="_blank" href="http://codecanyon.net/downloads"><?php _e('Leave a Review', $this->textdomain); ?></a> | 
		        	<a href="<?php echo admin_url('admin.php?page=wpfepp_form_manager'); ?>"><?php _e('Forms', $this->textdomain); ?></a> | 
		        	<a href="<?php echo admin_url('admin.php?page=wpfepp_settings') ?>"><?php _e('Settings', $this->textdomain); ?></a>
		        	<a style="float:right;" id="wpfepp-dismiss-nag" href="#"><?php _e('Dismiss This Message', $this->textdomain); ?></a>
		        </p>
		    </div>
		<?php
	}
