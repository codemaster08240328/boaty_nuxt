...
class WPFEPP_Tab_Settings_Data extends WPFEPP_Tab
{
	...
	public function create_options(){
		...
		add_settings_section( $section, __('Data Settings', $this->textdomain), array($this, 'section_callback'), $tab );

		register_setting( $tab, $option_id, array($this->validator, 'validate') );

	    add_settings_field(
	        'delete_on_uninstall', __('Delete All Data on Uninstallation', $this->textdomain), $callback, $tab, $section,
	        array_merge(
				array(
					'desc' 	=> __('If you want to permanently remove this plugin then you might want to set this to true.', $this->textdomain),
