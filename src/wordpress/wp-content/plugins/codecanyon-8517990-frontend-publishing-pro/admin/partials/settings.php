...
<div id="icon-options-general" class="icon32"></div>
	<h2><?php echo stripslashes($form['name']); ?> <?php _e('Settings', $this->textdomain); ?> <img id="wpfepp-loading" src="<?php echo plugins_url('static/img/loading.gif', dirname(dirname(__FILE__))); ?>" /></h2>
