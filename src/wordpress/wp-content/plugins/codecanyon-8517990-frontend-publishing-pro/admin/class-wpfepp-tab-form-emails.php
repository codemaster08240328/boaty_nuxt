...
class WPFEPP_Tab_Form_Emails extends WPFEPP_Tab
{
	...
	public function display() {
		...
		add_settings_field(
		    'user_email_subject', __('User Email Subject', $this->textdomain), $callback, $page, $section,
		    array_merge(
				array(
		...
		add_settings_field(
		    'user_email_content', __('User Email Content', $this->textdomain), $callback, $page, $section,
		    array_merge(
				array(
		...
		add_settings_field(
		    'admin_email_subject', __('Admin Email Subject', $this->textdomain), $callback, $page, $section,
		    array_merge(
				array(
		...
		add_settings_field(
		    'admin_email_content', __('Admin Email Content', $this->textdomain), $callback, $page, $section,
		    array_merge(
				array(
		...
		?>
			<form method="POST">
				...
				<?php submit_button(__('Save Changes', $this->textdomain), 'primary', 'update-form-emails'); ?>
			</form>
		<?php
	}
	...
	public function section_callback($args){
		?>
			<p class="description"><?php printf('%s <a href="'.admin_url('admin.php?page=wpfepp_settings&tab=email').'">%s</a>.', __('You can enable or disable the notification emails in the settings tab of this form. The sender name, sender address and email format can be modified', $this->textdomain), __('here', $this->textdomain)); ?></p>
