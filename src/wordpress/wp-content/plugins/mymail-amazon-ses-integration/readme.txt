...
> This Plugin requires [MyMail Newsletter Plugin for WordPress](http://rxa.li/mymail?utm_campaign=wporg&utm_source=AmazonSES+integration+for+MyMail)

Uses Amazon's Simple Email Service (SES) to deliver emails for the [MyMail Newsletter Plugin for WordPress](http://rxa.li/mymail?utm_campaign=wporg&utm_source=AmazonSES+integration+for+MyMail).
