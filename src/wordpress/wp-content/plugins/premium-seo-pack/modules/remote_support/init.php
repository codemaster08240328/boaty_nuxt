...
?>
		...
		<div class="<?php echo $this->the_plugin->alias; ?>">
			...
			<div class="<?php echo $this->the_plugin->alias; ?>-content">
				...
				<!-- Content -->
				<section class="<?php echo $this->the_plugin->alias; ?>-main psp-remote-support">
						
					<?php 
					echo psp()->print_section_header(
						$this->module['remote_support']['menu']['title'],
						$this->module['remote_support']['description'],
						$this->module['remote_support']['help']['url']
					);
					?>
					...
					<div class="panel panel-default <?php echo $this->the_plugin->alias; ?>-panel">
						...
						<div class="panel-heading psp-panel-heading">
							<h2><?php _e('Remote Support Details', 'psp');?></h2>
						</div>
								        ...
								        <div class="psp-panel-content">
								            <form id="psp_access_details" class="psp-form">
								                <div class="psp-form-row">
								                    <label for="protocol">Create WP Credentials</label>
								                    <div class="psp-form-item large">
								                        <span class="formNote">Automatically create a wordpress administrator account for the AA-Team support team?</span>
								                        ...
								                        <div class="psp-wp-credential" <?php echo ( isset($remote_access['psp-create_wp_credential']) && trim($remote_access['psp-create_wp_credential']) == 'yes' ? 'style="display:block"' : 'style="display:none"' );?>>
								                        	...
								                        	<div class="psp-message psp-info"><i>(these details will be sent automatically with your opened ticket)</i></div>
								                        </div>
								                    </div>
								                </div>
								                <div class="psp-form-row">
								                    <label for="onsite_cart">Allow remote file access</label>
								                    <div class="psp-form-item large">
								                        <span class="formNote">Automatically give the AA-Team support team access to your chosen server path?</span>
								                ...
								                <div class="psp-button-row">
								                    <input type="submit" class="psp-form-button psp-form-button-info" value="Save Remote Access" style="float: left;" />
								                </div>
								            </form>
								        </div>
							    	</div>
			                        	...
			                        	<div class="psp-panel">
											<div class="psp-panel-content">
												<div class="psp-message psp-info">
													...
													?>
														In order to contact the AA-Team support team you need to login into: support.aa-team.com
													<?php 
													}
													
													else{
													?>
														Testing your token is still valid on AA-Team support website ...
	                        			...
	                        			<div class="psp-panel">
											<div class="psp-panel-content">
												<form class="psp-form" id="psp-form-login">
													...
													<div class="psp-button-row">
														<input type="submit" class="psp-form-button psp-form-button-info" value="Login" style="float: left;" />
													</div>
												</form>
						            		</div>
						            	</div>
                        				...
                        				<div class="psp-panel">
											<div class="psp-panel-content">
												<form class="psp-form" id="psp-form-register">
													...
													<div class="psp-button-row">
														<input type="submit" class="psp-form-button psp-form-button-info" value="Register and login" style="float: left;" />
													</div>
												</form>
						            		</div>
						            	</div>
					...
					<div class="psp-grid_4" style="display: none;" id="psp-boxid-ticket">
						<div class="panel panel-default <?php echo $this->the_plugin->alias; ?>-panel">
							<div class="panel-heading psp-panel-heading">
								<h2><?php _e('Details about problem:', 'psp');?></h2>
							</div>
									    ...
									    <div class="psp-panel">
									        <div class="psp-panel-content">
									            <form id="psp_add_ticket" class="psp-form">
									                ...
									                <div class="psp-button-row">
									                    <input type="submit" class="psp-form-button psp-form-button-success" value="Open ticket on support.aa-team.com" style="float: left;" />
									                </div>
									            </form>
									        </div>
									    </div>
